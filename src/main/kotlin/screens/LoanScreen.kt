    ...
    fun LoanList() {
        ...
        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            LoanCard(
                ...
                onApply = { navigator?.push(ApplyLoanScreen("Home Loan")) }
            )
            LoanCard(
                title = "Car Loan",
                ...
                onApply = { navigator?.push(ApplyLoanScreen("Car Loan")) }
            )
            LoanCard(
                title = "Education Loan",
                description = "Support your or your child's education with this loan.",
                benefits = listOf("Covers tuition and living expenses", "Flexible repayment after graduation", "Lower interest rates for higher studies"),
